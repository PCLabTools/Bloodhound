...
echo Initiating Build for Upload to MCU for Project: %PROJECT_NAME%

%COMPILER% --upload --pref build.path=%SOURCE_FOLDER%\build --board %BOARD_TYPE% --port %COM_PORT% --verbose /%PROJECT_NAME%.ino
